...
Source: https://peterwildeford.substack.com/p/now-is-a-great-time-to-get-a-career

---

[![](https://substackcdn.com/image/fetch/$s_!fICe!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffa91f8b5-304d-40d2-9ebf-39c1c58004af_1258x792.png)](https://substackcdn.com/image/fetch/$s_!fICe!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffa91f8b5-304d-40d2-9ebf-39c1c58004af_1258x792.png)
...
First up is me! I work at the [Institute for AI Policy and Strategy](https://www.iaps.ai/) (IAPS), a DC + remote think tank focused on US federal AI policy (and also some work in the UK).

**We’re hiring for several roles:**

* **[Researchers and Senior Researchers for our Frontier Security team](https://www.iaps.ai/researcher-frontier-security)**, offering $81K-$220K/yr to work on cutting-edge AI security challenges that directly influence US defense and national security policy.
...
* **[Researchers and Senior Researchers for our Compute Policy team](https://www.iaps.ai/researcher-compute-policy)**. Also a salary of $81K-$220K/yr depending on experience. The ideal candidate has prior experience working with AI, tech policy, chips/semiconductors, export controls, data center security, hardware-based access controls, or supply chains.
* **[Senior Researcher - AI International Strategy](https://www.iaps.ai/senior-researcher-international-strategy)** to play a central role conducting research and engaging policymakers.Salary of $111K-$220K. The ideal candidate has strong thinking on the topics of AI and geopolitics.
* **Senior Research Manager (or Director) in either [Frontier Security](https://www.iaps.ai/research-manager-frontier-security) or [Compute Policy](https://www.iaps.ai/research-manager-compute-policy)** to help lead our respective research teams and manage a team of 3-6 researchers. Here we are prioritizing research management, project management skills, and understanding of the AI landscape. Salary of $111K-$220K. 6+ years of research/policy experience with prior management experience is key.
...
[Learn more and apply](https://www.iaps.ai/careers)
...
[Apply here](https://www.rand.org/global-and-emerging-risks/centers/technology-and-security-policy/get-involved.html) or [message Michael Aird on Twitter](https://x.com/michael__aird/status/1946157167175684576) with questions. These roles are open to non-Americans.

[Learn more and apply](https://www.rand.org/global-and-emerging-risks/centers/technology-and-security-policy/get-involved.html)
...
**Princeton's Laboratory for AI** **[seeks Policy Fellows](https://puwebp.princeton.edu/AcadHire/apply/application.xhtml?listingId=38822) to embed with federal and state agencies** in a unique program offering $130K-$180K to advance responsible AI development from inside government.
...
[Explore Princeton](https://puwebp.princeton.edu/AcadHire/apply/application.xhtml?listingId=38822)
...
At the leadership level, CNAS seeks a **[Fellow/Senior Fellow](https://www.cnas.org/careers/fellow-senior-fellow)** for their Technology and National Security Program to lead research on mitigating risks from advanced AI capabilities, including AI-enabled cyber and biological weapons development, misaligned AI behaviors, and recursive AI improvement.

They're also hiring an **[Associate Fellow](https://www.cnas.org/careers/associate-fellow-2)** with 3-5 years of experience to conduct deep research on AI security while engaging senior government officials and technology leaders.

Supporting these senior researchers will be two **[Research Assistants/Associates](https://www.cnas.org/careers/research-assistant-research-associate)** — one focused on AI risks and governance, another specializing in compute governance and semiconductor policy.

A **[Project Coordinator](https://www.cnas.org/careers/project-coordinator)** will orchestrate the entire initiative, managing complex logistics, tracking deliverables, and supporting strategic policy development.
...
[Learn about CNAS's roles](https://www.cnas.org/careers/)
...
[Apply to the EU AI Office](https://ec.europa.eu/eusurvey/runner/AIOffice-Interest-General)
...
[Explore BlueDot](https://bluedot.org/join-us/e18d5d61-8c13-4023-a241-c1dcb0222143)
...
[Learn more about Encode](https://docs.google.com/document/d/1UxruiF1jo5s956wbyRZp_SNrE1y4SNE0MF3-MkM5sqQ/edit?tab=t.0)
...
**The role is remote anywhere in the US, but with a preference for working from Berkeley CA**. The ideal candidate brings **3+ years of operations/finance experience** (or exceptional writing/communication skills), thrives in fast-paced environments, and gets impatient when projects aren't moving forward. Experience with 501c4s or startups is a major plus. They're evaluating applications on a **rolling basis**, so apply ASAP through their [application form](https://airtable.com/apppz8EW71aaJM78d/pagX5J3jikKAMl92Q/form).

[Learn more about ops](https://docs.google.com/document/d/1pndG3mJJGrg6MMv5iFRQHPUUvvq2Si1ZxZTKtzY3e8Y/edit?tab=t.0)

[Chief of Staff](https://docs.google.com/document/d/12KbY0h_lyhWdIN_O66vj2709i9lUIXMdAwhLbMbRlOQ/edit?tab=t.0)

~

#### **[CLOSED] Define AI governance at the Centre for the Governance of AI**

The Centre for the Governance of AI (GovAI) is recruiting for two roles — **[Research Scholars](https://www.governance.ai/post/research-scholar)** and **[Research Fellows](https://www.governance.ai/post/research-fellow)** — shaping how humanity navigates the AI transition. GovAI has helped define the field since 2018, with alumni now working AI governance at DeepMind, OpenAI, Anthropic, and government positions.
...
The Future Society seeks a **[Research Fellow](https://thefuturesociety.org/work-with-us/)** contractor to help prepare the US government for potential crises involving the most powerful AI systems, including eventual AGI — building concrete operational playbooks and mapping complex response networks for scenarios.
...
Want more career leads as well as AI analysis? Subscribe!
