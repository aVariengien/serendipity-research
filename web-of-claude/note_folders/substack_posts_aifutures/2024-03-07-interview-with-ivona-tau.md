# Interview with Ivona Tau

*GANs and the aesthetics of motion*

Published: 2024-03-07
Source: https://aifutures.substack.com/p/interview-with-ivona-tau
...
[Listen Now](https://aifutures.substack.com/p/episode-2-exploring-the-intersection)
...
**KA: I do see a duality, or two aspects that are dovetailing together. You've used the term [motion painting](https://ivonatau.com/reimagined-hong-kong-neons). Do you want to talk about that a little bit?**
...
[![](https://substackcdn.com/image/fetch/$s_!131C!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6dcf0a68-241c-4558-8cd6-15e0355fd728_533x800.png)](https://substackcdn.com/image/fetch/$s_!131C!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6dcf0a68-241c-4558-8cd6-15e0355fd728_533x800.png)
...
And it’s also interesting to explore and experiment conceptually. For example, with the project I did for last year's Art Basel Miami with Tezos \-  *[Whispers (in code)](https://www.fxhash.xyz/generative/21879)*, I used generative art to create textures and images but the AI element was embedded in the code itself. So even within this long form generative art project, there was an interactive AI model living inside the code, which was analyzing the image and providing instructions on how this image could be improved. This is a different way of using AI than we are used to. AI was not used to generate images or generate text,  but **it was used as part of the code to create decisions for interactivity in the piece**. I find these kinds of different approaches to combining AI and code particularly fascinating.

[![](https://substackcdn.com/image/fetch/$s_!Ec43!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7e5c2bd2-2441-40fc-bc0e-4b854b5422d6_660x662.png)](https://substackcdn.com/image/fetch/$s_!Ec43!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7e5c2bd2-2441-40fc-bc0e-4b854b5422d6_660x662.png)

##### [WHISPERS (in code) \#20](https://www.fxhash.xyz/gentk/1363795), Project \#21879 — iteration \#20, Minted on November 29, 2022 at 08:56
...
**KA:  So many interrelationships between physical and digital. So \- in terms of text, I was going to ask you about** ***[Study of Atom](https://ivonatau.com/study-of-atom-in-analog-digital-and-ai)*****. I noticed that in this project you were bringing text in as an element in a way you don’t always do in other works. Can you tell me a bit more about how this one came about?**
...
[![](https://substackcdn.com/image/fetch/$s_!XZ-S!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F66965246-b7b1-4469-8a9c-aff124f5e421_800x804.png)](https://substackcdn.com/image/fetch/$s_!XZ-S!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F66965246-b7b1-4469-8a9c-aff124f5e421_800x804.png)
...
[![](https://substackcdn.com/image/fetch/$s_!jQfQ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F35f223e6-79b4-4fd5-843d-c4d4714c2fc8_800x804.png)](https://substackcdn.com/image/fetch/$s_!jQfQ!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F35f223e6-79b4-4fd5-843d-c4d4714c2fc8_800x804.png)
...
**KA:  I also wanted to ask you about your recent project,** ***[Machine Hearted](https://ivonatau.com/machine-hearted)*****. You just released that project this month. Can you tell us about that project?**
...
[![](https://substackcdn.com/image/fetch/$s_!dv_J!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0d81330e-132d-4dc3-ab52-ecac0fd968a4_750x1125.png)](https://substackcdn.com/image/fetch/$s_!dv_J!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0d81330e-132d-4dc3-ab52-ecac0fd968a4_750x1125.png)
