...
Source: https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together

---

[![](https://substackcdn.com/image/fetch/$s_!pl1i!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc6b88533-ed1e-4f87-8dbd-0baa672700c4_1024x1024.webp)](https://substackcdn.com/image/fetch/$s_!pl1i!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc6b88533-ed1e-4f87-8dbd-0baa672700c4_1024x1024.webp)

*This post was inspired by some talks at the recent [LessOnline](https://less.online/) conference including one by LessWrong user “[Gene Smith](https://www.lesswrong.com/users/genesmith?from=post_header)”.*
...
Ethics aside[1](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-1-146404078), what would be necessary to actually do this?
...
“Get an IVF embryo and gene\-edit it to have the desired genes” (again, ethics and legality aside)[3](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-3-146404078) is a lot harder than it sounds.
...
If you look at the list of 37 [approved gene and cell therapies](https://www.fda.gov/vaccines-blood-biologics/cellular-gene-therapy-products/approved-cellular-and-gene-therapy-products) to date,
...
In 2013, [Carl Shulman and Nick Bostrom](https://nickbostrom.com/papers/embryo.pdf) proposed that “iterated embryo selection” could be used for human cognitive enhancement, to produce individuals with extremely high IQ.

The procedure goes:

1. select embryos that have high polygenic scores
2. extract embryonic stem cells from those embryos and convert them to eggs and sperm
3. cross the eggs and sperm to make new embryos
4. repeat until large genetic changes have accumulated.
...
Moreover, it’s not trivial to “just” turn an embryonic stem cell into an egg or sperm in the lab. That’s known as *[in vitro gametogenesis](https://www.brown.edu/news/2023-10-23/adashi-ivg#:~:text=During%20IVF%2C%20an%20egg%20is,cell%20in%20a%20person's%20body.)* and though it’s an active area of research, we’re not quite there yet.

#### Iterated *Meiosis*?

There may be an easier way (as developmental biologist Metacelsus pointed out in 2022\): [meiosis.](https://denovo.substack.com/p/meiosis-is-all-you-need)

His procedure is:

1. take a diploid[4](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-4-146404078) cell line
2. induce meiosis and generate many haploid cell lines
3. genotype the cell lines and select the best ones
4. fuse two haploid cells together to re\-generate a diploid cell line
5. repeat as desired.

Meiosis is the process by which a diploid cell, with two copies of every chromosome, turns into f[our haploid cells](https://en.wikipedia.org/wiki/Meiosis) each with a single copy of every chromosome.
...
[![](https://substackcdn.com/image/fetch/$s_!At7u!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe4c98768-5070-4098-b2d0-f2372e8c1144_2560x1610.png)](https://substackcdn.com/image/fetch/$s_!At7u!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe4c98768-5070-4098-b2d0-f2372e8c1144_2560x1610.png)
...
Recently, he solved this problem! Here’s the [preprint.](https://www.biorxiv.org/content/10.1101/2024.05.31.596483v1)
...
Now, it’s been known for a while that you can differentiate a typical somatic cell (like a skin cell) into a pluripotent stem cell that can differentiate into different tissues. That’s what an [induced pluripotent stem cell (iPSC) is!](https://en.wikipedia.org/wiki/Induced_pluripotent_stem_cell)
...
Well, one thing we still don’t know how to do in vitro is [sex\-specific imprinting](https://en.wikipedia.org/wiki/Genomic_imprinting), the epigenetic phenomenon that causes some genes to be expressed or not depending on whether you got them from your mother or father.
...
This isn’t trivial; when genomic imprinting goes wrong we get fairly serious developmental disabilities like [Angelman Syndrome](https://en.wikipedia.org/wiki/Angelman_syndrome).
...
And I haven’t even touched on the question of how reliable polygenic scores are, and particularly how likely it is for an embryo optimized for an *extremely* high polygenic scoreto actually result in an extreme level of the desired trait.[5](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-5-146404078)
...
[1](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-anchor-1-146404078)and my own ethical view is that nobody’s civil rights should be in any way violated on account of their genetic code, and that reasonable precautions should be taken to make sure novel human reproductive tech is safe.

[2](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-anchor-2-146404078)especially for controversial traits like IQ.

[3](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-anchor-3-146404078)it’s famously illegal to [“CRISPR” a baby.](https://www.wired.com/story/the-crispr-baby-scientist-is-back-heres-what-hes-doing-next/)

[4](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-anchor-4-146404078)most cells in the human body are “diploid”, having 2 copies of every chromosome; only eggs and sperm are “haploid”, having 1 copy of every chromosome.

[5](https://sarahconstantin.substack.com/p/superbabies-putting-the-pieces-together#footnote-anchor-5-146404078)“correlation is not causation” becomes relevant here; if too much of the polygenic score is picking up on *non\-causal correlates* of the trait, then selecting an embryo to have an ultra\-high score will be optimizing the wrong stuff and won’t help much.   
