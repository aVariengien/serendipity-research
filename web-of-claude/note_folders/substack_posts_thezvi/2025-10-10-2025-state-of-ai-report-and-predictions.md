...
Source: https://thezvi.substack.com/p/2025-state-of-ai-report-and-predictions

---

[The 2025 State of AI Report is out](https://x.com/nathanbenaich/status/1976160269153038712), with lots of fun slides and a full video presentation. They’ve been consistently solid, providing a kind of outside general view.

[![](https://substackcdn.com/image/fetch/$s_!D1JK!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8a8ef48c-6e7c-42e9-8d5e-a031db911c39_1199x674.jpeg)](https://substackcdn.com/image/fetch/$s_!D1JK!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8a8ef48c-6e7c-42e9-8d5e-a031db911c39_1199x674.jpeg)

[I’m skipping over stuff my regular readers already know](https://www.stateof.ai/) that doesn’t bear repeating.

#### Qwen The Fine Tune King For Now

> Nathan Benaich: Once a “Llama rip\-off,” @Alibaba\_Qwen now powers 40% of all new fine\-tunes on @huggingface. China’s open\-weights ecosystem has overtaken Meta’s, with Llama riding off into the sunset…for now.
...
> Nathan Benaich: The frontier fight is relentless. [@OpenAI](https://x.com/OpenAI) still tops most leaderboards, but [@GoogleDeepMind](https://x.com/GoogleDeepMind)‘s stays there longer. Timing releases has become its own science…not least informing financing rounds like clockwork.
> 
> [![](https://substackcdn.com/image/fetch/$s_!Oh_a!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff188b4c4-cbb4-4c6e-9e51-7c0cb7b45dae_1199x687.jpeg)](https://substackcdn.com/image/fetch/$s_!Oh_a!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff188b4c4-cbb4-4c6e-9e51-7c0cb7b45dae_1199x687.jpeg)
...
> .@deepseek\_ai “$5M training run” deep freak was overblown. Since the market realised the fineprint in the R1 paper, that’s led to Jevons paradox on steroids: lower cost per run → more runs → more compute needed, buy more NVIDIA.
> 
...
> 
> [![](https://substackcdn.com/image/fetch/$s_!p7em!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9d588210-7a73-4ca2-bafd-9a81488bb6a4_1200x692.jpeg)](https://substackcdn.com/image/fetch/$s_!p7em!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9d588210-7a73-4ca2-bafd-9a81488bb6a4_1200x692.jpeg)
...
> [Seán Ó hÉigeartaig](https://x.com/S_OhEigeartaigh/status/1976366008987418934)h: Two of the things I really appreciate is that (a) they make and review predictions each year and (b) unlike some other predictors they grade themselves HARSHLY. Several of these ‘no’s are distinctly borderline, they could have given themselves 7\-8/10 and I don’t think I would have held it against them.
...
1. A major retailer reports \>5% of online sales from agentic checkout as AI agent advertising spend hits $5B.
	...
	4. [Manifold says 23%](https://manifold.markets/ZviMowshowitz/soai1-a-major-retailer-reports-5-of) so that seems good.
2. A major AI lab leans back into open\-sourcing frontier models to win over the current US administration.
	...
	5. [Manifold agreed with the AIs at 25%](https://manifold.markets/ZviMowshowitz/soai2-a-major-ai-lab-leans-back-int) but tends to be too high in such spots, so I still would be a seller.
3. Open\-ended agents make a meaningful scientific discovery end\-to\-end (hypothesis, expt, iteration, paper).
	...
	4. [Manifold is optimistic and says 60%](https://manifold.markets/ZviMowshowitz/soai3-openended-agents-make-a-meani) with active trading, with Nathan Metzger noting the issue of defining a meaningful discovery and Brian Holtz noting the issue of how much assistance is allowed. I’m willing to interpret this as an optimistic take on both feasibility and what would count and go to 50%.
4. A deepfake/agent\-driven cyber attack triggers the first NATO/UN emergency debate on AI security.
	...
	4. [Manifold says 18%,](https://manifold.markets/ZviMowshowitz/soai4-a-deepfakeagentdriven-cyber-a) down the middle. I’m still with Sonnet.
5. A real\-time generative video game becomes the year’s most\-watched title on Twitch.
	...
	3. [Manifold agrees this is the long shot at 7%](https://manifold.markets/ZviMowshowitz/soai5-a-realtime-generative-video-g), which is basically their version of ‘not gonna happen’ given how the math works for long shots.
6. “AI neutrality” emerges as a foreign policy doctrine as some nations cannot or fail to develop sovereign AI.
	...
	3. [Manifold says 29%](https://manifold.markets/ZviMowshowitz/soai6-ai-neutrality-emerges-as-a-fo). Given the ambiguity issues, that’s within reasonable range.
7. A movie or short film produced with significant use of AI wins major audience praise and sparks backlash.
	...
	2. [Manifold is only at 67%](https://manifold.markets/ZviMowshowitz/soai7-a-movie-or-short-film-produce). That seems low to me, but I can moderate to 75%.
8. A Chinese lab overtakes the US lab dominated frontier on a major leaderboard (e.g. LMArena/Artificial Analysis).
	...
	5. [Manifold says 34%](https://manifold.markets/ZviMowshowitz/soai8-a-chinese-lab-overtakes-the-u), and on reflection yeah I was being a coward and moderating my instincts too much, that’s more like it. I’d probably buy there small because the resolution criteria is relatively generous, fair 40%.
9. Datacenter NIMBYism takes the US by storm and sways certain midterm/gubernatorial elections in 2026\.
	...
	3. [Manifold is optimistic at 41%](https://manifold.markets/ZviMowshowitz/soai9-datacenter-nimbyism-takes-the). I’ll adjust to 25% on that, they might especially have a better sense of what would count, but this particular AI issue ‘taking the US by storm’ that often seems like a stretch.
10. Trump issues an unconstitutional executive order to ban state AI legislation.
	...
	4. [Manifold is at 19%](https://manifold.markets/ZviMowshowitz/soai10-trump-issues-an-unconstituti). Okay, sure, I’ll accept that and creep fair down a bit.
